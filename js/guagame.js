...
class GuaGame {
    ...
    drawImageAnimation(element) {
         o.context.drawImage(element.image, element.sx, element.sy, element.swidth, element.sheight, element.x, element.y, element.width, element.height)
    }
 ...
 //给画布添加元素
    ...
    drawAll() {
        ...
        this.elementsAnimation.forEach( (v, i) => {
            this.drawImage(v)
        })
